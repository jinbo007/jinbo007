...
# 网易云音乐API
SEARCH_API = "https://music.163.com/api/search"
...
def get_song_url(song_id):
    ...
    try:
        ...
        response = requests.get(SONG_URL_API, params=params, headers=headers, timeout=10)
        data = response.json()
